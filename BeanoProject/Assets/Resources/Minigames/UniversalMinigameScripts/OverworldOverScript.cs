...
public class OverworldOverScript : MonoBehaviour {
	...
	{
		CountDownTimerToEnd ();
		//if time has elapsed at the end of the minigame
		if (timeElapsed) {
			//return to the main menu
            CustomLobby.local.EndOverworld();
		}
	}
